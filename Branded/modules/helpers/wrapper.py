                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://envs.sh/wpl.jpg",
                                title="🥀 Queen Userbot ✨",
                                thumb_url=f"https://envs.sh/wpl.jpg",
                                description=f"🌷 Deploy Your Own Queen-Userbot 🌿...",
                                caption=f"<b>🥀 Welcome » To » Queen 🌷\n✅ Userbot {__version__} ✨...</b>",
