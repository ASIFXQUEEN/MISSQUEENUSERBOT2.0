...
LOVERAID = [
    "SUNA JANICHA KI TAME ETE CUTE J MOON BHI TAMA AGARE FIKA LAGE",
    "TAMA KATHA BAHUT SWEET LAGE TAMA PARI",
    "TAME SABU JHIYA THU SPECAL",
    "TAME KN JANIVA KETE BHALA PAE TAMAKU",
    "TAMA KAJALA AKHI MO HRUDAYARE GARA TANILANI",
    "ICHA HAUCHI TAMA CUTE FACE KU PRINT KARI MO AKHI SAMNA RE RAKHIBI",
    "MOON TAMARA DUPLICATE COPY",
    "YE SUNDARI TAMA AKHI ETE SUNDAR KEMITI",
    "TAMA BINA TA MU ADHURA",
    "GOTE JHIYA ETE SUNDAR HEIPARIBA AJI TAMA SAHA KATHA HELE PARE JANILI",
    "TAME KN JANIBA J MO BHALA PAIBA TAMA CHADA KAU JHIYA KU AKHI UTHEIKI DEKHINI MU",
    "MO DREEM TAMA SAHITA BASIBI TAME TAMA CUTE HATARE MATE KHUAIDABA",
    "EMITI CUTE SMILE SABU BELE  KARUTHIBA ",
    "MU TAMA RASTA RE FULO BICHEI DEBI TAMA PADA TALE LAGIBAKU DEBINI",
    "MO DREEM J TAME VC ASIBA EKUTIYA MATE BHI DAKIBA TAPARE JIE ASILE TAKU KAHIBA TK PARE ASA TAPARE TAME MO SAHITA KATHA HABA ",
    "TAME HELA MO DREEM GIRL SWITE",
    "TAME CUTE TAME APSARI",
    "TAMA KU BAHUT PILA PASAND KARANTI BUT MU TK SPECIAL",
    "I LOVE LO MO DHANA ",
